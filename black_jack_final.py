...
class Bet:
    def __init__(self, com_bankroll=10000000, human_bankroll=200):
        """

        :type com_bankroll: number
        """
    ...
    def selecting_winner(self, winner_inside):
        """
        :param winner_inside:
        :return:
        """
...
while main_game:
    while game:
        ...
        while com_game:
            if 21 >= com_card_value > human_card_value:
                print("com Won")
                winner = 'com'
                game = False
                break
